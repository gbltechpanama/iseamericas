...
<div id="galleryWrapper">
    ...
    <?php else: ?>
        ...
        <p style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#039; font-weight:bold; width:100%; text-align:center">
        	NO HAY IMAGENES QUE MOSTRAR EN ESTA CATEGORIA.
        </p>
        <hr style="width:60%" />
